...
@section('content')
  ...
  <!-- Page Heading -->
    ...
    <option {{ ($resident->brgy) == 'Santo Niño' ? 'selected' : '' }}  value="Santo Niño">Santo Niño</option>
                      ...
                      placeholder="Ilocos Norte"  value="{{ old('province',$resident->province) }}" required autocomplete="province">
    ...
    <option {{ ($resident->ps) == 'Yes' ? 'selected' : '' }}  value="Yes">Yes</option>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" onclick="return confirm('are you sure you want to update?')">
                                    {{ __('Update') }}
                                </button>
